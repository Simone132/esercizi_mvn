        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    String isContainedSql = "SELECT EXISTS (SELECT * FROM prodotti WHERE id = " + productId + ") AS isContained;";
                ...
                case 3:
                    ...
                    while (true) {
                        try {
                            ...
                            String productNewPriceString = scanner.nextLine();
                            productNewPrice = Double.parseDouble(productNewPriceString.replace(",", "."));
